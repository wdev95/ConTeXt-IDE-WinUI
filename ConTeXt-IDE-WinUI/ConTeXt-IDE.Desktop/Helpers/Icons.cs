...
/// <summary>
/// Method 1: Markup Extension
/// In xaml head: xmlns:h="using:ConTeXt_IDE.Helpers"
/// Usage: <FontIcon Glyph="{h:FI Symbol=Save}"></FontIcon>
/// </summary>
/// <remarks>
/// Works with IntelliSense because of the Usage of enum: Typing "Symbol=" will show all available symbols.
/// </remarks>
/// <returns>
/// string (for usage with "Glyph=...")
/// </returns>
[MarkupExtensionReturnType(ReturnType = typeof(string))]
public partial class FIExtension : MarkupExtension
{
 public FontIconSymbol Symbol { get; set; }
...
/// <summary>
/// Method 2: Attached Property
/// In xaml head: xmlns:h="using:ConTeXt_IDE.Helpers"
/// Usage: <FontIcon h:FI.Symbol="Save"></FontIcon>
/// </summary>
/// <remarks>
/// Works with IntelliSense because of the Usage of enum: Typing "Symbol=" will show all available symbols.
/// </remarks>
...
public static class FI
{
 ...
 public static void SetSymbol(DependencyObject obj, FontIconSymbol value)
 {
  obj.SetValue(SymbolProperty, value);
 }

 public static FontIconSymbol GetSymbol(DependencyObject obj)
 {
  return (FontIconSymbol)obj.GetValue(SymbolProperty);
 }

 private static void OnSymbolChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
 {
  if (d is FontIcon fontIcon && e.NewValue is FontIconSymbol newSymbol)
  {
	fontIcon.Glyph = char.ConvertFromUtf32((int)newSymbol);
  }
 }
}

/// <summary>
/// FontIconSymbol enumeration.
/// </summary>
public enum FontIconSymbol
{
