...
{
 public static CornerRadius GetDynamicCornerRadius(ContentControl button) =>
				 (CornerRadius)button.GetValue(DynamicCornerRadiusProperty);

 public static void SetDynamicCornerRadius(ContentControl button, CornerRadius value) =>
				 button.SetValue(DynamicCornerRadiusProperty, value);

 public static readonly DependencyProperty DynamicCornerRadiusProperty =
				 DependencyProperty.RegisterAttached(
								 "DynamicCornerRadius",
								 typeof(CornerRadius),
								 typeof(ButtonHelper),
								 new PropertyMetadata(new CornerRadius(0), OnDynamicCornerRadiusChanged));

 private static void OnDynamicCornerRadiusChanged(DependencyObject d, DependencyPropertyChangedEventArgs e)
 {
  if (d is ContentControl button)
  {
	button.CornerRadius = (CornerRadius)e.NewValue;
  }
 }
}
