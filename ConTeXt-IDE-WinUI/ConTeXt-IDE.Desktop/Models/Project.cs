...
namespace ConTeXt_IDE.Models
{
 ...
 var property = typeof(Project).GetProperty(e.PropertyName, BindingFlags.Instance | BindingFlags.Public);
	if (property?.GetCustomAttribute<JsonIgnoreAttribute>() != null)
	 return;

	if (Settings.IsApplyingExternalSettings)
	 return;
  ...
  [JsonIgnore]
  public bool IsOpenedInAnyInstance { get => Get(false); set => Set(value); }

  [JsonIgnore]
  public bool IsCurrentInThisWindow { get => Get(false); set => Set(value); }

	[JsonIgnore]
	public bool CanOpenInNewInstance { get => Get(false); set => Set(value); }
  ...
  public bool UseNonStopMode { get => Get(false); set => Set(value); }
